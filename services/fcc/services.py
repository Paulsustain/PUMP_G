...
def clear_restart_flag():
    ...
    try:
        ...
        con.commit()
        con.close()
        my_logger.info('restart flag cleared')
        return True
    except Exception as e:
        print(e)
...
def set_transaction_details(device_address,nozzle_address,liters,amount,ppu,read_at):
    try:
        ...
        con.commit()
        con.close()
        my_logger.info('transaction end details inserted successfully')
        return True
    except Exception as e:
        print(e)
        my_logger.exception(e)
    ...
    try:
        ...
        if max_id:
            ...
            sql_query="""
                        ...
                        """
            print(sql_query)
            cur.execute(sql_query,(total_volume,total_money,read_at,liters,ppu,amount,read_at,max_id))
        con.commit()
        con.close()
        my_logger.info('transaction end details inserted successfully')
        return True
...
def set_end_transaction_details_old(nozzle_address,total_volume,total_money,liters,amount,ppu,read_at):
    try:
        con,cur=connect_db()
        sql_query="""
                    select MAX(id) from transaction_details where nozzle_address = {};
...
def set_start_transaction_details(device_address,pump_address,total_volume,total_money,read_at,site_id,device_id):
    try:
        ...
        con.commit()
        con.close()
        my_logger.info('transaction start details inserted successfully')
        return True
    except Exception as e:
        print(e)
        my_logger.exception(e)
    ...
    try:
        ...
        if max_id:
           ...
           # sql_query="""
            ...
            print(sql_query)
            cur.execute(sql_query,(read_at,liters,ppu,amount,read_at,max_id))
        con.commit()
        con.close()
        my_logger.info('transaction end details inserted successfully')
        return True
...
def is_open_totalizer_taken(nozzle_address):
    try:
        con,cur=connect_db()
        sql_query="""
                    select MAX(id) from transaction_details where nozzle_address = {};
        ...
        max_id=cur.fetchall()[0][0]
        print('max id is: {}'.format(max_id))
        start_totalizer=start_totalizer_money=None
        if max_id:
            sql_query="""
           ...
           # sql_query="""
            ...
            print(sql_query)
            cur.execute(sql_query)
            totalizer_details=cur.fetchall()[0]
            print(totalizer_details)
            start_totalizer,start_totalizer_money = totalizer_details
        con.close()
        if start_totalizer and start_totalizer_money:
            my_logger.info('start totalizer obtained')
            return True
        else:
            return False
    except Exception as e:
...
def set_transaction_end_old(nozzle_address,liters,amount,ppu,read_at):
    try:
        con,cur=connect_db()
        sql_query="""
                    select MAX(id) from transaction_details where nozzle_address = {};
        ...
        if len(ids) > 1:
            ...
            if result1:
                ...
                for id in ids:
                    ...
                    cur.execute(sql_query)
            con.commit()
            my_logger.info('price change effected succesfully for nozzle: {}'.format(address))
            print('data updated successfully')
        con.close()
...
def set_price(device_address,nozzle_address,price,set_by,set_at):
    ...
    try:
        ...
        print('data inserted successfully')
        con.close()
        my_logger.info('new price inserted successfully {}'.format(device_address,nozzle_address,price,set_by,set_at))
        return True
    except Exception as e:
        print(e)
        my_logger.exception(e)
...
def set_scheduled_price(device_address,address,price,user,current_time,time_scheduled):
    ...
    try:
        ...
        print('data inserted successfully')
        con.close()
        my_logger.info('new scheduled price inserted successfully {}'.format((device_address,address,price,user,current_time,time_scheduled)))
        return True
    except Exception as e:
        print(e)
        my_logger.exception(e)
...
def update_scheduled_price(device_address,address,price,user,current_time,time_scheduled):
    ...
    try:
        ...
        con.commit()
        print('data inserted successfully')
        my_logger.info('scheduled price moved to instant price {}'.format((device_address,nozzle_address,price,set_by,set_at,time_scheduled)))
        con.close() 
        return True
    except Exception as e:
        print(e)
...
def get_due_unused_scheduled_price():
    ...
    try:
        ...
        con.close()
        my_logger.info('due scheduled price exist: {}'.format(result))
        return result
    except Exception as e:
        print(e)
        my_logger.exception(e)
...
def get_unuploaded_transactions():
    ...
    try:
        ...
        if result:
            transactions=result
            print('data collected successfully')
            my_logger.info('unuploaded transactions exists and are: {}'.format(result))
        else:
            print('no data to upload')
            my_logger.info('no data to upload')
        con.close()
        #print('data collected successfully')
        return transactions
    except Exception as e:
...
def update_uploaded_transactions(ids):
    ...
    try:
        ...
        con.close()
        print('data updated successfully')
        my_logger.info('uploaded data updated successfully')
        return True
    except Exception as e:
        print(e)
        my_logger.exception(e)
...
def update_totalizer_checker(nozzle_address):
    ...
    try:
        ...
        my_logger.info('totalizer checker data updated successfully')
        return True
    except Exception as e:
        print(e)
        my_logger.exception(e)
...
def update_running_transaction(nozzle_address,state,timestamp):
    print('*********Nozzle address is : {} and state is: {} and timestamp is: {}********'.format(nozzle_address,state,timestamp))
    try:
        con,cur=connect_db()
        sql_query="""
                    update running_transaction set transaction_ongoing = {}, read_at = '{}' where nozzle_address = {};
        
        """.format(state,timestamp,nozzle_address)
        print(sql_query)
        cur.execute(sql_query)
        con.commit()
        con.close()
...
##        sleep(1000)
        ...
        print(e)
        return None
def get_transaction_running_status(nozzle_address):
#print('*********price is: {}******** before insert'.format(price))
    try:
        con,cur=connect_db()
        sql_query="""
        ...
        """.format(nozzle_address)
        cur.execute(sql_query)
        transaction_ongoing=cur.fetchall()[0][0]
        print('transaction_ongoing status is: {}'.format(transaction_ongoing))
        con.close()
        return transaction_ongoing
    except Exception as e:
        print(e)
        my_logger.exception(e)
        return None
...
def get_start_totalizer(nozzle_address):
#print('*********price is: {}******** before insert'.format(price))
    try:
        con,cur=connect_db()
        sql_query="""
        ...
        """.format(nozzle_address)
        cur.execute(sql_query)
        start_totalizer=cur.fetchall()[0][0]
        print('previous totalizer is: {}'.format(start_totalizer))
        con.close()
        return start_totalizer
    except Exception as e:
        print(e)
        my_logger.exception(e)
        return None
