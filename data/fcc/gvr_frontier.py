...
def get_transaction_details(pump_address):
    ...
    print(pumps)
    for pump in pumps:
        decimal_volume=pump['decimal_volume']
        decimal_amount=pump['decimal_amount']
        decimal_price=pump['decimal_price']
        
    print("the decimal price is",decimal_price)
    print("The decimal volume is ",decimal_volume)
    print("The decimal amount is ",decimal_amount)
    
    decimal_volume=10**decimal_volume
    decimal_amount=10**decimal_amount
    decimal_price=10**decimal_price
    print("formatted ppu decimal is",decimal_price)
    print("formatted volume decimal is",decimal_volume)
    print("formatted amount decimal is",decimal_amount)
    '''
   
    volume=volume/decimal_volume
    ppu=ppu/decimal_price
    money=money/decimal_amount
